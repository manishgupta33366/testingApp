...
public class PaymentInfoController {
	...
	@GetMapping(value = ConstantManager.paymentInfo, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	public String getPaymentInfo(@RequestParam(value="paymentMethod",required=true) String payment){
		
		Map<String,String> queryParams = new HashMap<>();
		queryParams.put("paymentMethod", payment);
