...
public class PhoneTypeController {
	...
	@GetMapping(value = ConstantManager.phoneType, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	public String getPhoneType(@RequestParam(value="status",required = true) String status){
