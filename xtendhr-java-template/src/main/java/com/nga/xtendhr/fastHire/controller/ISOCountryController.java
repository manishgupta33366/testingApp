...
public class ISOCountryController {
	...
	private static final Logger logger = LoggerFactory.getLogger(ISOCountryController.class);
	
	@GetMapping(value = ConstantManager.ISOCountry, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	public String getISOCountry(@RequestParam(value="status",required = true) String status){
