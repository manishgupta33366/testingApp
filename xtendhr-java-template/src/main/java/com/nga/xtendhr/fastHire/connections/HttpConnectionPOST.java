package com.nga.xtendhr.fastHire.connections;
...
import com.nga.xtendhr.fastHire.authentication.BasicAuthenticationHeaderProvider;
import com.nga.xtendhr.fastHire.connections.POJO.CustomStatus;
...
public class HttpConnectionPOST {
	...
	@SuppressWarnings("rawtypes")
	public HttpConnectionPOST(URI uri, DestinationConfiguration dConfig, Class className) {
		this.uri = uri;
		this.destinationConfiguration = dConfig;
		this.className = className;
	}
	...
	public String connectToServer() {
		...
		try {
			...
			logger.debug("className:"+className +"data:"+data);
