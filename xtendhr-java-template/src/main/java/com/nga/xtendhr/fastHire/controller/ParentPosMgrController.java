...
public class ParentPosMgrController {

	private static final String configName = "sfconfigname";
	private static final Logger logger = LoggerFactory.getLogger(ParentPosMgrController.class);
	
	@GetMapping(value = ConstantManager.parentPos, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	public String getParentPosition(@RequestParam(value="code",required = true) String code){
