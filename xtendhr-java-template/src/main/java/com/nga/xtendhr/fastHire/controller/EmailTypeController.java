...
public class EmailTypeController {
	...
	private static final Logger logger = LoggerFactory.getLogger(EmailTypeController.class);
	
	@GetMapping(value = ConstantManager.emailType, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
